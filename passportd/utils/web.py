...
_OAUTH2_PROVIDER_CONFIG: dict[str, dict[str, str]] = {
    ...
    "microsoft": {"icon": "fa-brands fa-microsoft", "color": "is-link", "bg": "#00a4ef"},
    "apple": {"icon": "fa-brands fa-apple", "color": "is-dark", "bg": "#000000"},
    "xiaomi": {"icon": "fa-brands fa-xiaomi", "color": "is-warning", "bg": "#ff6900"},
    "gitlab": {"icon": "fa-brands fa-gitlab", "color": "is-danger", "bg": "#fc6d26"},
    "bitbucket": {"icon": "fa-brands fa-bitbucket", "color": "is-link", "bg": "#0052cc"},
    "x-twitter": {"icon": "fa-brands fa-x-twitter", "color": "is-dark", "bg": "#000000"},
    "facebook": {"icon": "fa-brands fa-facebook", "color": "is-link", "bg": "#1877f2"},
    "linkedin": {"icon": "fa-brands fa-linkedin", "color": "is-link", "bg": "#0a66c2"},
    "amazon": {"icon": "fa-brands fa-amazon", "color": "is-warning", "bg": "#ff9900"},
    "alipay": {"icon": "fa-brands fa-alipay", "color": "is-link", "bg": "#1677ff"},
    "discord": {"icon": "fa-brands fa-discord", "color": "is-link", "bg": "#5865f2"},
    "slack": {"icon": "fa-brands fa-slack", "color": "is-dark", "bg": "#4a154b"},
    "line": {"icon": "fa-brands fa-line", "color": "is-success", "bg": "#00c300"},
    "telegram": {"icon": "fa-brands fa-telegram", "color": "is-link", "bg": "#26a5e4"},
    "whatsapp": {"icon": "fa-brands fa-whatsapp", "color": "is-success", "bg": "#25d366"},
    "paypal": {"icon": "fa-brands fa-paypal", "color": "is-link", "bg": "#003087"},
    "twitch": {"icon": "fa-brands fa-twitch", "color": "is-info", "bg": "#9146ff"},
    "reddit": {"icon": "fa-brands fa-reddit", "color": "is-danger", "bg": "#ff4500"},
    "instagram": {"icon": "fa-brands fa-instagram", "color": "is-danger", "bg": "#e4405f"},
    "vk": {"icon": "fa-brands fa-vk", "color": "is-link", "bg": "#0077ff"},
    "stack-overflow": {"icon": "fa-brands fa-stack-overflow", "color": "is-warning", "bg": "#f48024"},
}
